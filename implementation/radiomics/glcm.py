...
class RadiomicsGLCM(base.RadiomicsFeaturesBase):
  ...
  def _calculateMatrix(self, voxelCoordinates=None):
    ...
    # Optionally apply a weighting factor. For voxelSpacing, preserve exact
    # standard behavior when spacing is isotropic. Under anisotropic spacing,
    # keep each directional GLCM separate and apply spacing-aware weights during
    # the final angular feature aggregation. This avoids building a synthetic
    # averaged GLCM before non-linear feature formulas are evaluated.
    pixelSpacing = self.inputImage.GetSpacing()[::-1]
    angleWeights = None
    if self.weightingNorm == 'voxelSpacing' and spacing_utils.is_isotropic_spacing(pixelSpacing):
      self.logger.debug('voxelSpacing requested on isotropic spacing; using standard unweighted angular handling')
    elif self.weightingNorm == 'voxelSpacing':
      self.logger.debug('Applying voxelSpacing angular feature weighting')
      angleWeights = []

      for a in angles:
        relative_distance = spacing_utils.compute_relative_offset_distance(a, pixelSpacing)
        angleWeights.append(1.0 / max(relative_distance, 1e-5))

      angleWeights = numpy.array(angleWeights, dtype='float')
      angleWeights /= angleWeights.sum()
    elif self.weightingNorm is not None:
      ...
      # Normalize and apply weights to the matrix.
      weights /= weights.sum()
      P_glcm = numpy.sum(P_glcm * weights[None, None, None, :], axis=3, keepdims=True)
    ...
    if P_glcm.shape[3] > 1:
      ...
      if len(emptyAngles[0]) > 0:  # One or more angles are 'empty'
        ...
        if angleWeights is not None:
          angleWeights = numpy.delete(angleWeights, emptyAngles[0])
          angleWeights /= angleWeights.sum()
      else:
    ...
    self._angleWeights = angleWeights
    return P_glcm

  def _calculateAngleAverage(self, values, axis=-1):
    """
    Average per-angle feature values.

    Standard PyRadiomics behavior is the unweighted NaN-aware mean across
    angles. When voxelSpacing weights are active, this function replaces only
    that angular aggregation step with normalized physical-spacing weights.
    """
    weights = self._angleWeights
    if weights is None:
      return numpy.nanmean(values, axis)

    values = numpy.asarray(values)
    values = numpy.moveaxis(values, axis, -1)
    valid = numpy.isfinite(values)
    safe_values = numpy.where(valid, values, 0.0)
    weight_shape = (1,) * (safe_values.ndim - 1) + (weights.shape[0],)
    reshaped_weights = weights.reshape(weight_shape)
    valid_weights = numpy.where(valid, reshaped_weights, 0.0)
    denominator = numpy.sum(valid_weights, axis=-1)
    numerator = numpy.sum(safe_values * reshaped_weights, axis=-1)

    with numpy.errstate(invalid='ignore', divide='ignore'):
      result = numerator / denominator
    return numpy.where(denominator == 0, numpy.nan, result)
  ...
  def getAutocorrelationFeatureValue(self):
    ...
    **1. Autocorrelation**
    ...
    return self._calculateAngleAverage(ac, -1)
  ...
  def getJointAverageFeatureValue(self):
    ...
    **2. Joint Average**
    ...
    return self._calculateAngleAverage(self.coefficients['ux'], -1).mean((1, 2))
  ...
  def getClusterProminenceFeatureValue(self):
    ...
    **3. Cluster Prominence**
    ...
    return self._calculateAngleAverage(cp, -1)
  ...
  def getClusterShadeFeatureValue(self):
    ...
    **4. Cluster Shade**
    ...
    return self._calculateAngleAverage(cs, -1)
  ...
  def getClusterTendencyFeatureValue(self):
    ...
    **5. Cluster Tendency**
    ...
    return self._calculateAngleAverage(ct, -1)
  ...
  def getContrastFeatureValue(self):
    ...
    **6. Contrast**
    ...
    return self._calculateAngleAverage(cont, -1)
  ...
  def getCorrelationFeatureValue(self):
    ...
    **7. Correlation**
    ...
    return self._calculateAngleAverage(corr, -1).mean((1, 2))
  ...
  def getDifferenceAverageFeatureValue(self):
    ...
    **8. Difference Average**
    ...
    return self._calculateAngleAverage(diffavg, -1)
  ...
  def getDifferenceEntropyFeatureValue(self):
    ...
    **9. Difference Entropy**
    ...
    return self._calculateAngleAverage(difent, -1)
  ...
  def getDifferenceVarianceFeatureValue(self):
    ...
    **10. Difference Variance**
    ...
    return self._calculateAngleAverage(diffvar, -1)
  ...
  def getJointEnergyFeatureValue(self):
    ...
    **11. Joint Energy**
    ...
    return self._calculateAngleAverage(ene, -1)
  ...
  def getJointEntropyFeatureValue(self):
    ...
    **12. Joint Entropy**
    ...
    return self._calculateAngleAverage(ent, -1)
  ...
  def getImc1FeatureValue(self):
    ...
    **13. Informational Measure of Correlation (IMC) 1**
    ...
    return self._calculateAngleAverage(imc1, -1)
  ...
  def getImc2FeatureValue(self):
    ...
    **14. Informational Measure of Correlation (IMC) 2**
    ...
    return self._calculateAngleAverage(imc2, -1)
  ...
  def getIdmFeatureValue(self):
    ...
    **15. Inverse Difference Moment (IDM)**
    ...
    return self._calculateAngleAverage(idm, -1)
  ...
  def getMCCFeatureValue(self):
    ...
    **16. Maximal Correlation Coefficient (MCC)**
    ...
    return self._calculateAngleAverage(MCC, -1).real
  ...
  def getIdmnFeatureValue(self):
    ...
    **17. Inverse Difference Moment Normalized (IDMN)**
    ...
    return self._calculateAngleAverage(idmn, -1)
  ...
  def getIdFeatureValue(self):
    ...
    **18. Inverse Difference (ID)**
    ...
    return self._calculateAngleAverage(invDiff, -1)
  ...
  def getIdnFeatureValue(self):
    ...
    **19. Inverse Difference Normalized (IDN)**
    ...
    return self._calculateAngleAverage(idn, -1)
  ...
  def getInverseVarianceFeatureValue(self):
    ...
    **20. Inverse Variance**
    ...
    return self._calculateAngleAverage(inv, -1)
  ...
  def getMaximumProbabilityFeatureValue(self):
    ...
    **21. Maximum Probability**
    ...
    return self._calculateAngleAverage(maxprob, -1)
  ...
  def getSumAverageFeatureValue(self):
    ...
    **22. Sum Average**
    ...
    return self._calculateAngleAverage(sumavg, -1)
  ...
  def getSumEntropyFeatureValue(self):
    ...
    **23. Sum Entropy**
    ...
    return self._calculateAngleAverage(sumentr, -1)
  ...
  def getSumSquaresFeatureValue(self):
    ...
    **24. Sum of Squares**
    ...
    return self._calculateAngleAverage(ss, -1)
